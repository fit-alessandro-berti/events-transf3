...
'gradient_conflict_log_interval':25,
...
'fmv3_head':{
'classification_mode':'global_local', # legacy_soft_knn, local, global, global_local, coverage_fallback
...
'classification_separate_projections_enabled':True,
'classification_projection_hidden_dim':256,
'classification_private_transformer_layers':1,
'semantic_candidate_decoder_enabled':True,
'semantic_temperature':0.2,
'semantic_support_strength':1.0,
'support_gate_kappa':2.0,
'process_candidate_decoder_enabled':True,
'process_candidate_hidden_dim':256,
'process_candidate_dropout':0.1,
'process_candidate_strength':1.0,
'support_fitted_classifier_enabled':True,
'support_fitted_regularization':10.0,
'support_fitted_strength':1.0,
...
'natural':0.60,
'long_tail':0.20,
'missing_local_label':0.10,
'balanced':0.10,
},
'deployment_case_episodes':True,
...
'support_scenarios':['natural','coverage_aware'],
'repetitions':5,
...
'prior_strengths':[1.0],
'retrieval_modes':['fm_structured_product'],
...
'evaluation_profiles':[
{'name':'main','retrieval_modes':['fm_structured_product'],'prior_modes':['balanced','natural'],'prior_strengths':[1.0],'retrieval_k':[5,20,50]},
],
},
}
